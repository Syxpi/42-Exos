...
- [42 Paris - Mon Parcours de Piscineuse (Lumi)](#)
  ...
  - [🏗️ Détails des exercices réalisés](#️-détails-des-exercices-réalisés)
    - [🐚 Module : Shell \& Git](#-module--shell--git)
    - [💻 Module : Imperative Programming](#-module--imperative-programming)
    - [🧠 Module : Memory Management](#-module--memory-management)
    - [🏗️ Module : Data Structures](#️-module--data-structures)
    - [🖥️ Module : Compilation and Preprocessing](#️-module--compilation-and-preprocessing)
    - [👩🏻‍💻 Module : System Interface](#-module--system-interface)
    - [🤷‍♀️ Module : Dynamic Data Structures](#️-module--dynamic-data-structures)
...
![Warning](https://syxpi.fr/42/Warn.png)

![Aveu de triche](https://syxpi.fr/42/Aveu.png)
...
![Level](https://syxpi.fr/42/Level.png)

**Mon Holy Graph** :

![Holy Graph](https://syxpi.fr/42/HolyGraph.png)

**Mes Stats de Venue** :

![Stats](https://syxpi.fr/42/Stats.png)
...
![Vue d'ensemble de Shell](https://syxpi.fr/42/Shell.png)
...
![Shell Fundamentals Tries](https://syxpi.fr/42/Shell-Fundamentals-Tries.png) 

- Git Fundamentals :

![Git Fundamentals Tries](https://syxpi.fr/42/Git-Fundamentals-Tries.png)

- Shell Searching And Finding :

![Shell Searching And Finding](https://syxpi.fr/42/Shell-Searching-And-Finding-Tries.png)
</details>

### 💻 Module : Imperative Programming
**Vue d'ensemble** :

![Vue d'ensemble d'Imperative Programming](https://syxpi.fr/42/Imperative-Programming.png)
...
![C Programming Tries](https://syxpi.fr/42/C-Programming-Fundamentals-Tries.png)

- C Characters Arithmetics :

![C Characters Arithmetics Tries](https://syxpi.fr/42/C-Characters-Arithmetics-Tries.png)

- C Algorithmics Fundamentals :

![C Algorithmics Tries](https://syxpi.fr/42/C-Algorithmics-Fundamentals-Tries.png)
</details>

### 🧠 Module : Memory Management
**Vue d'ensemble** :

![Vue d'ensemble de Memory Management](https://syxpi.fr/42/Memory-Management.png)
...
![C Pointers Tries](https://syxpi.fr/42/C-Pointers-Tries.png)

- C Simple Strings :

![C Simple Strings Tries](https://syxpi.fr/42/C-Simple-Strings-Tries.png)

- C Function Pointers :

![C Function Pointers Tries](https://syxpi.fr/42/C-Function-Pointers-Tries.png)

- C Memory Management Management :

![C Memory Management Tries](https://syxpi.fr/42/C-Memory-Management-Tries.png)

- C System Interface :

![C System Interface Tries](https://syxpi.fr/42/C-System-Interface-Tries.png)
</details>

### 🏗️ Module : Data Structures
**Vue d'ensemble** :

![Vue d'ensemble de Data Structures](https://syxpi.fr/42/Data-Structures.png)
...
![C-Strings Tries](https://syxpi.fr/42/C-Strings-Tries.png)

- C-Structures :

![C-Structures Tries](https://syxpi.fr/42/C-Structures-Tries.png)
</details>

### 🖥️ Module : Compilation and Preprocessing
**Vue d'ensemble** :

![Vue d'ensemble de Compilation and Preprocessing](https://syxpi.fr/42/Compilation-And-Preprocessing.png)
...
![Vue d'ensemble de System Interface](https://syxpi.fr/42/System-Interface.png)
...
![Vue d'ensemble de Dynamic Data Structures](https://syxpi.fr/42/Dynamic-Data-Structures.png)
...
![Exams](https://syxpi.fr/42/Exams-2026-03-23.png)

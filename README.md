...
![Aveu de triche](./Images/Aveu.png)
...
![Shell Fundamentals Tries](./Images/Shell-Fundamentals-Tries.png)

- Git Fundamentals :

![Git Fundamentals Tries](./Images/Git-Fundamentals-Tries.png)

- Shell Searching And Finding :

![Shell Searching And Finding](./Images/Shell-Searching-And-Finding-Tries.png)

### 💻 Module : Imperative Programming
**Vue d'ensemble** :

![Vue d'ensemble d'Imperative Programming](./Images/Imperative-Programming.png)
...
![C Programming Tries](./Images/C-Programming-Fundamentals-Tries.png)

- C Characters Arithmetics :

![C Characters Arithmetics Tries](./Images/C-Characters-Arithmetics-Tries.png)

- C Algorithmics Fundamentals :

![C Algorithmics Tries](./Images/C-Algorithmics-Fundamentals-Tries.png)

### 🧠 Module : Memory Management
**Vue d'ensemble** :

![Vue d'ensemble de Memory Management](./Images/Memory-Management.png)
...
![C Pointers Tries](./Images/C-Pointers-Tries.png)

- C Simple Strings :

![C Simple Strings Tries](./Images/C-Simple-Strings-Tries.png)

- C Function Pointers :

![C Function Pointers Tries](./Images/C-Function-Pointers-Tries.png)

- C Memory Management Management :

![C Memory Management Tries](./Images/C-Memory-Management-Tries.png)
...
![C-Structures Tries](./Images/C-Structures-Tries.png)

### 🖥️ Module : Compilation and Preprocessing
**Vue d'ensemble** :

![Vue d'ensemble de Compilation and Preprocessing](./Images/Compilation-And-Preprocessing.png)
...
![Vue d'ensemble de System Interface](./Images/System-Interface.png)
...
![Vue d'ensemble de Dynamic Data Structures](./Images/Dynamic-Data-Structures.png)
